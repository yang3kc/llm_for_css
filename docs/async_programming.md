...
- [Threading template](#template-scripts)
- [Async template](#template-scripts)
...
!!! warning
    ...
    If you are not in a rush, you should also consider the new [batch API](batch_processing.md), which is much easier to handle and costs only half the price.
...
See the full code and comparison between the sync and threading versions:

??? example "Full script: async_programming/compare_sync_threading.py"

    ```python
    --8<-- "async_programming/compare_sync_threading.py"
    ```
...
??? example "Full script: async_programming/compare_sync_async.py"

    ```python
    --8<-- "async_programming/compare_sync_async.py"
    ```
...
??? example "Threading template: async_programming/threading_template.py"

    ```python
    --8<-- "async_programming/threading_template.py"
    ```

??? example "Async template: async_programming/async_template.py"

    ```python
    --8<-- "async_programming/async_template.py"
    ```
